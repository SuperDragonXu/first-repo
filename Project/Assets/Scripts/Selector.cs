...
namespace UnityEngine.XR.Interaction.Toolkit
{
    public class Selector : MonoBehaviour
    {
        ...
        private void MoveSelectedGameobject(GameObject gameObject, float speed = 5.0f)
        {
            ...
            if (targetDevice.TryGetFeatureValue(CommonUsages.primary2DAxis, out Vector2 primary2DAxis_Value))
            {
                ...
                {
                    objectTransform.position += new Vector3(primary2DAxis_Value.x * speed * Time.deltaTime, 0,
            ...
            if (targetDevice.TryGetFeatureValue(CommonUsages.primaryButton, out bool primaryButton_Value))
            {
                ...
                {
                    objectTransform.position += new Vector3(0, 0.5f * speed * Time.deltaTime, 0);
                }
            }
